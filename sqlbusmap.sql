...
-- Bảng LICH_TRINH (1-N với Admin, KHÔNG CÓ MaTD) (DA SUA THEM O DONG MaTX, TenTX và ca làm việc) 
...
-- Bảng HOC_SINH (Tham chiếu PhuHuynh, XeBus, Admin) (DA SUA them khoa ngoai o MaTX)
...
-- 4.4. CHÈN LỊCH TRÌNH (Gán MaNV) (đã chỉnh sửa cho thông tin cho hợp lý)
INSERT INTO LichTrinh (MaLT, MaTX, TenTX, CaLamViec, GioXuatPhat, GioKetThuc )
VALUES
('LT01', 'TX01', N'Phạm Văn Tài', N'Sáng', '2025-10-10 06:30:00', '2025-10-10 07:15:00'),
('LT02', 'TX02', N'Hoàng Thị Xế', N'Chiều', '2025-10-10 17:45:00', '2025-10-10 07:30:00'),
('LT03', 'TX03', N'Trần Minh Lái', N'Sáng', '2025-10-11 06:30:00', '2025-10-11 07:15:00');
...
('PH14', 'Đỗ Thị Thúy', '123456789023', '0901111014', N'Tổ 14, Phường D', 'AD02'),
...
-- 4.8. CHÈN HỌC SINH (30 bản ghi - Gán MaNV) (HO CUA TAT CA HOC SINH DEU DA DUOC DOI va da duoc them MaTX)
...
('HT002', DATEADD(MINUTE, -5, GETDATE()), N'Đang dừng đón học sinh tại tổ 8', 'XEBUS02', 'AD02'),
